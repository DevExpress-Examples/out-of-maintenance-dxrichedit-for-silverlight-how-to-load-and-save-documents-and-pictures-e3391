...
Namespace Export_Import_Example
	Partial Public Class MainPage
		...
		Private sampleText As String = "{\rtf1\deff0{\fonttbl{\f0 Times New Roman;}}" & ControlChars.CrLf & "{\colortbl\red0\green0\blue0 ;\red0\green0\blue255 ;\red51\green51\blue153 ;\red204\green255\blue255 ;\red0\green0\blue128 ;\red204\green153\blue255 ;}" & ControlChars.CrLf & "{\stylesheet {\ql\cf0 Normal;}{\*\cs1\cf0 Default Paragraph Font;}}" & ControlChars.CrLf & "\sectd\pard\plain\qc\fs52\par\pard\plain\qc\fs52\par\pard\plain\qc{\fs52\cf0 This}{\cf0  }" & ControlChars.CrLf & "{\fs32\cf0 te}{\b\fs32\cf0 xt}{\b\cf0  }{\b\fs96\cf0 c}{\b\super\fs96\cf0 o}{\b\fs96\cf0 n}" & ControlChars.CrLf & "{\b\sub\fs96\cf0 t}{\b\fs96\cf0 a}{\b\super\fs96\cf0 i}{\b\fs96\cf0 n}{\b\sub\fs96\cf0 s}" & ControlChars.CrLf & "{\b\cf2  }{\b\ul\cf3\chcbpat4 diffe}{\b\ul\cf0 rent }{\b\i\ul\fs96\cf0 chara}{\b\ul\fs96\cf0 cter f}" & ControlChars.CrLf & "{\b\ul\fs96\cf5 or}{\b\fs96\cf5 mat}{\b\fs96\cf0 ting in one }{\fs96\cf0 paragraph.}\par}"
...
'			#Region "#saveimage"
			Dim imgs As DocumentImageCollection = richEditControl1.Document.GetImages(richEditControl1.Document.Selection)
			If imgs.Count > 0 Then
				Dim ms As New MemoryStream(imgs(0).Image.GetImageBytesSafe(RichEditImageFormat.Png))
				Dim sfdlg As New SaveFileDialog()
