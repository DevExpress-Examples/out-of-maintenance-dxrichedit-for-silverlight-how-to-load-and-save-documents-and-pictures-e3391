...
Namespace Export_Import_Example
	...
	Public Class IsolatedStorageUriProvider
		...
		Public Function CreateCssUri(ByVal rootUri As String, ByVal styleText As String, ByVal relativeUri As String) _
 As String Implements IUriProvider.CreateCssUri
		...
		End Function
		Public Function CreateImageUri(ByVal rootUri As String, ByVal image As RichEditImage, ByVal relativeUri As String) _
 As String Implements IUriProvider.CreateImageUri
			...
			Using fStream As IsolatedStorageFileStream = store.CreateFile(imageName)
				Using ms As New MemoryStream(image.GetImageBytesSafe(RichEditImageFormat.Png))
					ms.WriteTo(fStream)
				End Using
			End Using
